...
import com.example.criptos.presentation.CoinList.CoinAdapter
import com.example.criptos.presentation.CoinList.CoinListViewModel
...
class MainActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sort.setOnClickListener{
            tempCoinList.sortWith { o1, o2 -> o1!!.book.compareTo(o2!!.book) }
